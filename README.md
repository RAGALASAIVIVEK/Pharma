...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">Pharma Plus</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Welcome to Pharma Plus</h1>
        <p>Welcome to Pharma Plus,our purposeis to sell Online medicines in onlineand healthcare products.
  ...
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 Pharma Plus. All rights reserved. BY RAGALA SAI VIVEK</p>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Contact Us - Pharma Plus</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          23-422/Hitech City<br>
          India, 524302<br><br>
          <strong>Email:</strong><br>
          abc@Pharma_Plus.com<br><br>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div id="mission">
          <h2>Mission</h2>
          <p>Our mission at Pharma Plus is to revolutionize the way people access essential medicines and healthcare products. We strive to:
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Products - Pharma Plus</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="dabur.png" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
              <h5 class="card-title">Dabur</h5>
              <p class="card-text">DDABUR Arjuna Tablets - 60 Tabs | Promotes Heart Health | Manages Cholesterol Level | Promotes Healthy Metabolism</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="cir.png" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
              <h5 class="card-title">Tablets</h5>
              <p class="card-text">HealthyHey Nutrition Curcumin with Bioperine 1310mg (Ultra Pure) | 90 Vegetable Capsules with Piperine</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="ortho.png" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
              <h5 class="card-title">Patanjali</h5>
              <p class="card-text">PATANJALI DIVYA ORTHOGRIT TABLET 60 N</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
        </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 Pharma Plus. All rights reserved.  RAGALA SAI VIVEK</p>
  </footer>
  <body background="bg.jpeg" style="background-repeat: no-repeat; background-size: cover;">
